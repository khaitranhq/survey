...
[![GoDoc](http://img.shields.io/badge/godoc-reference-5272B4.svg)](https://pkg.go.dev/github.com/khaitranhq/survey)
...
and likely to break your application in these situations. See [#337](https://github.com/khaitranhq/survey/pull/337#issue-581351617)
...
`github.com/khaitranhq/survey/terminal.InterruptErr` from `Ask` or `AskOne`.
